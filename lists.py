...
lists = {
    ...
    "ACTION": ["approach grad school admissions"],
    "SUBJECT": ["machine learning", "atmospheric science", "computer science", "physics", "bioengineering", "astronomy", "neuroscience", "molecular biology", "applied math", "biochemistry", "developmental psychology"],
    "NOBEL": ["Richard Feynman", "Albert Einstein", "Oe Kenzaburo", "Linus Pauling", "Marie Curie"],
}
